...
function initDatabase(defaultElectionName) {
  ...
  const defaults = [
    ...
    ["results_sms_auto_enabled", "false"],
    ["results_sms_auto_last_attempt_at", ""],
    ["results_sms_auto_last_attempt_fingerprint", ""],
    ["results_sms_last_sent_at", ""],
    ["results_sms_last_fingerprint", ""],
    ["results_sms_last_success_count", "0"],
    ["results_sms_last_failure_count", "0"],
